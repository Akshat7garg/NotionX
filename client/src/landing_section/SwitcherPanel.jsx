...
function SwitcherPanel() {
  ...
  return (
    <div className='h-full w-full border-6 border-mountain-2 bg-cream-3 rounded-2xl flex flex-col items-center justify-start p-3 md:p-3 lg:p-4 gap-2 md:gap-3 lg:gap-4'>

      {/* Toggle buttons for switching between Notes and Todos */}
      <div className='relative flex items-center justify-center w-fit h-fit border-5 border-cream-4 bg-cream-2 rounded-xl'>
